...
interface SourceFactory {
    ...
    companion object {
        ...
        val REAL_BUFFERED_SOURCE: SourceFactory =
            object :
                SourceFactory {
                override val isOneByteAtATime: Boolean
                    get() = false
         ...
         */
        val ONE_BYTE_AT_A_TIME_BUFFERED_SOURCE: SourceFactory =
            object :
                SourceFactory {
                override val isOneByteAtATime: Boolean
                    get() = true
        ...
        val ONE_BYTE_AT_A_TIME_BUFFER: SourceFactory =
            object :
                SourceFactory {
                override val isOneByteAtATime: Boolean
                    get() = true
        ...
        val PEEK_BUFFERED_SOURCE: SourceFactory =
            object :
                SourceFactory {
                override val isOneByteAtATime: Boolean
                    get() = false
