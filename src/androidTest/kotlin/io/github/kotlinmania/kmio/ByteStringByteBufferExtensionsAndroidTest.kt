...
/**
 * Android-target mirror of `ByteStringByteBufferExtensionsTest`. The
 * `bytestring/android/src/ByteStringAndroidExt.kt` file is a byte-identical
 * copy of its JVM counterpart, so these tests exercise the same public
 * surface bound to the Android-target compilation. Kover counts the
 * Android copy of the file separately from the JVM copy; without this
 * mirror the project line-coverage stays below the 95 percent gate.
 */
public class ByteStringByteBufferExtensionsAndroidTest {
    @Test
