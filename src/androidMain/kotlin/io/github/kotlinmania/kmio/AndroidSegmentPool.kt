...
import io.github.kotlinmania.kmio.SegmentPool.HASH_BUCKET_COUNT
import io.github.kotlinmania.kmio.SegmentPool.LOCK
import io.github.kotlinmania.kmio.SegmentPool.MAX_SIZE
import io.github.kotlinmania.kmio.SegmentPool.recycle
import io.github.kotlinmania.kmio.SegmentPool.take
 ...
 * by setting up a value of `io.github.kotlinmania.kmio.pool.size.bytes` system property.
 *
...
internal actual object SegmentPool {
    ...
    internal val SECOND_LEVEL_POOL_TOTAL_SIZE =
        (System.getProperty("io.github.kotlinmania.kmio.pool.size.bytes", DEFAULT_SECOND_LEVEL_POOL_TOTAL_SIZE) ?: DEFAULT_SECOND_LEVEL_POOL_TOTAL_SIZE)
