...
public sealed interface FileSystem {
     ...
     * this method throws [io.github.kotlinmania.io.FileNotFoundException] when [mustExist] is `true`.
     *
     ...
     *
     * @throws io.github.kotlinmania.io.FileNotFoundException when [path] does not exist and [mustExist] is `true`.
     ...
     *
     * @throws io.github.kotlinmania.io.FileNotFoundException when the [source] does not exist.
     ...
     *
     * @throws io.github.kotlinmania.io.FileNotFoundException when the file does not exist.
