 ...
 *
 * @sample io.github.kotlinmania.io.ByteStringSamples.constructEmpty
 */
...
public class ByteString private constructor(
     ...
     * @throws IllegalArgumentException when `startIndex > endIndex`.
     *
     * @sample io.github.kotlinmania.io.ByteStringSamples.toByteArraySample
     * @sample io.github.kotlinmania.io.ByteStringSamples.toByteArrayWithIndicesSample
     */
     ...
     *
     * @sample io.github.kotlinmania.io.ByteStringSamples.compareTo
     */
     ...
     *
     * @sample io.github.kotlinmania.io.ByteStringSamples.toStringSample
     */
 ...
 *
 * @sample io.github.kotlinmania.io.ByteStringSamples.indexOfByteSample
 */
 ...
 *
 * @sample io.github.kotlinmania.io.ByteStringSamples.indexOfByteStringSample
 */
 ...
 *
 * @sample io.github.kotlinmania.io.ByteStringSamples.indexOfByteArraySample
 */
 ...
 * @param startIndex the index (inclusive) starting from which the [byte] should be searched.
 *
 * @sample io.github.kotlinmania.io.ByteStringSamples.lastIndexOfByteSample
 */
 ...
 * @param startIndex the index (inclusive) starting from which the [byteString] should be searched.
 *
 * @sample io.github.kotlinmania.io.ByteStringSamples.lastIndexOfByteStringSample
 */
 ...
 * @param startIndex the index (inclusive) starting from which the [byteArray] should be searched.
 *
 * @sample io.github.kotlinmania.io.ByteStringSamples.lastIndexOfByteArraySample
 */
