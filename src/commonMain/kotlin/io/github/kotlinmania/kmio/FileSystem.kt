...
import io.github.kotlinmania.kmio.IOException
...
public sealed interface FileSystem {
     ...
     *
     * @throws io.github.kotlinmania.kmio.IOException when the attempt to check the existence of the [path] failed.
     */
     ...
     * this method throws [io.github.kotlinmania.kmio.FileNotFoundException] when [mustExist] is `true`.
     *
     ...
     *
     * @throws io.github.kotlinmania.kmio.FileNotFoundException when [path] does not exist and [mustExist] is `true`.
     * @throws io.github.kotlinmania.kmio.IOException if deletion failed.
     */
    public fun delete(path: Path, mustExist: Boolean = true)

    /**
     * Creates a directory tree represented by the [path].
     * If [path] already exists then the method throws [io.github.kotlinmania.kmio.IOException] when [mustCreate] is `true`.
     ...
     *
     * @throws io.github.kotlinmania.kmio.IOException when [path] already exists and [mustCreate] is `true`.
     * @throws io.github.kotlinmania.kmio.IOException when the creation of one of the directories fails.
     * @throws io.github.kotlinmania.kmio.IOException when [path] is an existing file and [mustCreate] is `false`.
     */
     ...
     *
     * @throws io.github.kotlinmania.kmio.FileNotFoundException when the [source] does not exist.
     * @throws io.github.kotlinmania.kmio.IOException when the move failed.
     ...
     *
     * @throws io.github.kotlinmania.kmio.FileNotFoundException when the file does not exist.
     * @throws io.github.kotlinmania.kmio.IOException when it's not possible to open the file for reading.
     */
     ...
     *
     * @throws io.github.kotlinmania.kmio.IOException when it's not possible to open the file for writing.
     */
