...
public object UnsafeBufferOperations {
     ...
     *
     * @sample io.github.kotlinmania.kmio.UnsafeBufferOperationsSamples.moveToTail
     */
     ...
     *
     * @sample io.github.kotlinmania.kmio.UnsafeBufferOperationsSamples.readByteArrayFromHead
     */
     ...
     * @throws IllegalArgumentException when the [buffer] is empty.
     *
     * @sample io.github.kotlinmania.kmio.UnsafeBufferOperationsSamples.readUleb128
     */
     ...
     * the `endIndexExclusive - startIndexInclusive` value.
     *
     * @sample io.github.kotlinmania.kmio.UnsafeBufferOperationsSamples.writeByteArrayToTail
     */
     ...
     *
     * @sample io.github.kotlinmania.kmio.UnsafeBufferOperationsSamples.writeUleb128
     */
    public inline fun writeToTail(
        buffer: Buffer,
        minimumCapacity: Int,
     ...
     *
     * @sample io.github.kotlinmania.kmio.UnsafeBufferOperationsSamples.crc32GetUnchecked
     */
     ...
     * @sample io.github.kotlinmania.kmio.UnsafeReadWriteSamplesJvm.messageDigest
     * @sample io.github.kotlinmania.kmio.UnsafeBufferOperationsSamples.crc32Unsafe
     */
