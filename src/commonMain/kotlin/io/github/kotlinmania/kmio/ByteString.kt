 ...
 *
 * @sample io.github.kotlinmania.kmio.ByteStringSamples.constructionFromBytesSample
 */
 ...
 * @param bytes a sequence of bytes to be wrapped.
 *
 * @sample io.github.kotlinmania.kmio.ByteStringSamples.constructionFromUBytesSample
 */
 ...
 *
 * @sample io.github.kotlinmania.kmio.ByteStringSamples.constructEmpty
 */
...
public class ByteString private constructor(
     ...
     *
     * @sample io.github.kotlinmania.kmio.ByteStringSamples.constructionSample
     */
     ...
     * @throws IllegalArgumentException when `startIndex > endIndex`.
     *
     * @sample io.github.kotlinmania.kmio.ByteStringSamples.toByteArraySample
     * @sample io.github.kotlinmania.kmio.ByteStringSamples.toByteArrayWithIndicesSample
     */
     ...
     * @throws IllegalArgumentException when `startIndex > endIndex`.
     *
     * @sample io.github.kotlinmania.kmio.ByteStringSamples.copyToSample
     */
    public fun copyInto(
     ...
     * @throws IllegalArgumentException when `startIndex > endIndex`.
     *
     * @sample io.github.kotlinmania.kmio.ByteStringSamples.substringSample
     */
     ...
     *
     * @sample io.github.kotlinmania.kmio.ByteStringSamples.compareTo
     */
     ...
     *
     * @sample io.github.kotlinmania.kmio.ByteStringSamples.toStringSample
     */
 ...
 *
 * @sample io.github.kotlinmania.kmio.ByteStringSamples.indexOfByteSample
 */
 ...
 *
 * @sample io.github.kotlinmania.kmio.ByteStringSamples.indexOfByteStringSample
 */
 ...
 *
 * @sample io.github.kotlinmania.kmio.ByteStringSamples.indexOfByteArraySample
 */
 ...
 * @param startIndex the index (inclusive) starting from which the [byte] should be searched.
 *
 * @sample io.github.kotlinmania.kmio.ByteStringSamples.lastIndexOfByteSample
 */
 ...
 * @param startIndex the index (inclusive) starting from which the [byteString] should be searched.
 *
 * @sample io.github.kotlinmania.kmio.ByteStringSamples.lastIndexOfByteStringSample
 */
 ...
 * @param startIndex the index (inclusive) starting from which the [byteArray] should be searched.
 *
 * @sample io.github.kotlinmania.kmio.ByteStringSamples.lastIndexOfByteArraySample
 */
 ...
 *
 * @sample io.github.kotlinmania.kmio.ByteStringSamples.startsWithByteArraySample
 */
 ...
 *
 * @sample io.github.kotlinmania.kmio.ByteStringSamples.startsWithByteStringSample
 */
 ...
 *
 * @sample io.github.kotlinmania.kmio.ByteStringSamples.endsWithByteArraySample
 */
 ...
 *
 * @sample io.github.kotlinmania.kmio.ByteStringSamples.endsWithByteStringSample
 */
 ...
 *
 * @sample io.github.kotlinmania.kmio.ByteStringSamples.encodeAndDecodeUtf8String
 */
